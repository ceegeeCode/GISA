...
The code in this module allows to generate the plots in the Note and the Supplementary Data. To run it on your
own machine
1) run the GIsquared (C-code) with appropriate settings (values of parameters and paths to folders)
...
#############################################################################
# Generating plots for main Note ("links paper")
#############################################################################
...
pokeLength = 10
loopLength = 30
fileName = root + r'\ClosedLoopChars_minmax_computeGI_top100_loops' + str(loopLength) + '_pokeLength' + str(pokeLength) + '_thrL09P08.txt'
...
chainsFile = root + r'\chains_closed_loops_top100_thrL09P08.txt'
...
#sort the results and plot distributions (parts of) and link/poke examples (outside cutOff's)
chainsFile = root + r'\chains_subChainPairs_top100.txt'
...
#To generate distr plot (in main Note):
...
fig = git.histoClosedLoops_minMax(links_top8000_cl, pokes_top8000_cl, pokesMinMax_b =1, color = 'grey', supTitle_b = 0, binsLinks=100, binsPokes =100, linksDistrPlotsInSubPlots_b =2, pokesDistrPlotsInSubPlots_b =0, linksShowTopNr = 100, pokesShowTopNr = 100, cutOffLinks = 0.95, cutOffPokes = 0.9, plotPokeExs_b = 0, plotLinkExs_b = 0, plotLinksTop10_b = 1, plotPokesTop10_b = 0, chainsFile = chainsFile, intervalLinks = [-1.1,-.95], intervalPokes = [-0.75,-.74], plotExsInInt_b =0, titlePokesI = titlePokesI, titlePokesII = titlePokesII, lowerPercentile = 0.1, upperPercentile = 0.9)
...
pokeLength = 10
loopLength = 30
fileName = root + r'\ClosedLoopChars_minmax_computeGI_top8000_loops' + str(loopLength) + '_pokeLength' + str(pokeLength) + '_thrL09P08.txt'
dict_top8000_cl, links_top8000_cl, pokesAll_top8000_cl,  pokesMin_top8000_cl, pokesMax_top8000_cl = git.readResultsCcode_closedLoops(inputFileName = fileName, normalize_b = 1, minMaxOut_b = 1)
#sort the results and plot distributions (parts of) and link/poke examples (outside cutOff's)
chainsFile = root + r'\chains_closed_loops_top8000_thrL09P08.txt'
titlePokesI = 'Distribution of writhe values for potential pokes of length ' + str(pokeLength) 
titlePokesII = ' writhe values for potential pokes of length ' + str(pokeLength) 
pokes_top8000_cl = pokesAll_top8000_cl, pokesMin_top8000_cl, pokesMax_top8000_cl
fig = git.histoClosedLoops_minMax(links_top8000_cl, pokes_top8000_cl, pokesMinMax_b =1, color = 'grey', supTitle_b = 0, binsLinks=100, binsPokes =100, linksDistrPlotsInSubPlots_b =2, pokesDistrPlotsInSubPlots_b =1, linksShowTopNr = 100, pokesShowTopNr = 100, cutOffLinks = 0.95, cutOffPokes = 0.9, plotPokeExs_b = 0, plotLinkExs_b = 0, plotLinksTop10_b = 1, plotPokesTop10_b = 0, chainsFile = chainsFile, intervalLinks = [-1.1,-.95], intervalPokes = [-0.75,-.74], plotExsInInt_b =0, titlePokesI = titlePokesI, titlePokesII = titlePokesII, lowerPercentile = 0.1, upperPercentile = 0.9)

subChainLength = 15
fileName= root + r'\SubChainPairChars_minmax_computeGI_top8000_subChainLength' + str(subChainLength) + '_thrL09P08.txt'
dict_top8000, extremeWrithes_top8000_All, extremeWrithes_top8000_Min, extremeWrithes_top8000_Max  = git.readResultsCcode_closedLoops(inputFileName = fileName, linksAndPokes_b = 0, minMaxOut_b = 1, normalize_b = 1)
#sort the results and plot distributions (parts of) and link/poke examples (outside cutOff's)
chainsFile = root + r'\chains_subChainPairs_top8000_thrL09P08.txt'
#convert structure and then plot
extremeWrithes_top8000 = extremeWrithes_top8000_All, extremeWrithes_top8000_Min, extremeWrithes_top8000_Max
git.histoSubChainPairs_minMax(extremeWrithes_top8000, bins=100, logCount_b = 0, color = 'grey', colorMin = 'lightgrey', colorMax = 'grey', alphaMin = 1.0, alphaMax = 0.8, supTitle_b = 0, titleDistr = 'Distribution of mutual writhe values', addSubplotToFirstPlot_b = 1, distrPlotsInSubPlots_b =0, showTopNr = 10, plotTop10_b = 1, plotExs_b = 0, chainsFile = chainsFile, interval = [-4,-3], plotExsInInt_b =0, stringPattern = '([\S]+)([^\w]+)([\w]+)(.pdb)', subChainLgth =  30, lowerPercentile = 0.05, upperPercentile = 0.95)
...
#############################################################################
# Unrestr search in top8000_aug sub-chain length 100  (plots not used)
#############################################################################

#unrestricted search in top8000_aug, lgth 30, 60 or 100:
subChainLength = 30
fileName= root + r'\SubChainPairChars_minmax_computeGI_top8000_aug_subChainLength' + str(subChainLength) + '.txt'
dict_top8000, extremeWrithes_top8000_All, extremeWrithes_top8000_Min, extremeWrithes_top8000_Max  = git.readResultsCcode_closedLoops(inputFileName = fileName, linksAndPokes_b = 0, minMaxOut_b = 1, normalize_b = 1)
#sort the results and plot distributions (parts of) and link/poke examples (outside cutOff's)
chainsFile = root + r'\chains_subChainPairs_top8000_aug.txt'
#convert structure and then plot
extremeWrithes_top8000 = extremeWrithes_top8000_All, extremeWrithes_top8000_Min, extremeWrithes_top8000_Max
git.histoSubChainPairs_minMax(extremeWrithes_top8000, bins=100, logCount_b = 0, color = 'grey', colorMin = 'lightgrey', colorMax = 'grey', alphaMin = 1.0, alphaMax = 0.8, supTitle_b = 0, titleDistr = 'Distribution of mutual writhe values', addSubplotToFirstPlot_b = 1, distrPlotsInSubPlots_b =0, showTopNr = 10, plotTop10_b = 0, plotExs_b = 0, chainsFile = chainsFile, interval = [-0.88, -0.875], plotExsInInt_b = 1, stringPattern = '([\S]+)([^\w]+)([\w]+)(.pdb)', subChainLgth =  30, lowerPercentile = 0.005, upperPercentile = 0.995)
...
#distr of writhe for lgth 15 and 30 in one plot ... plus "interesting examples":
lgth = 15
fileName = root + r'\SubChainPairChars_minmax_computeGI_top8000_subChainLength' + str(lgth) + '.txt'
dict_top8000, extremeWrithes_top8000_All, extremeWrithes_top8000_Min, extremeWrithes_top8000_Max = git.readResultsCcode_closedLoops(inputFileName = fileName, linksAndPokes_b = 0, minMaxOut_b = 1, normalize_b = 1)
#sort the results and plot distributions (parts of) and link/poke examples (outside cutOff's)
chainsFile = root + r'\chains_subChainPairs_top8000.txt'
#convert structure and then plot
extremeWrithes_top8000 = extremeWrithes_top8000_All, extremeWrithes_top8000_Min, extremeWrithes_top8000_Max
git.histoSubChainPairs_minMax(extremeWrithes_top8000, bins=100, color = 'blue', colorMin = 'orange', colorMax = 'blue', addSubplotToFirstPlot_b = 1, addSubPlotNr = 121, distrPlotsInSubPlots_b =0, showTopNr = 10, plotTop10_b = 1, plotExs_b = 0, chainsFile = chainsFile, interval = [-1.1,-1], plotExsInInt_b =0, subChainLgth =  15, lowerPercentile = 0.001, upperPercentile = 0.999)

#two projections in examples:
elevAzimList = [[15,-45],[160,-45]]
git.histoSubChainPairs_minMax(extremeWrithes_top8000, bins=100, elevAzimList = elevAzimList, color = 'blue', colorMin = 'orange', colorMax = 'blue', addSubplotToFirstPlot_b = 0, addSubPlotNr = 122, distrPlotsInSubPlots_b =0, showTopNr = 10, plotTop10_b = 1, plotExs_b = 0, chainsFile = chainsFile, interval = [-1.1,-1.0], plotExsInInt_b =0, subChainLgth =  15, lowerPercentile = 0.05, upperPercentile = 0.95)


# lgth 30:
lgth = 30
fileName = root + r'\SubChainPairChars_minmax_computeGI_top8000_subChainLength' + str(lgth) + '.txt'
dict_top8000, extremeWrithes_top8000_All, extremeWrithes_top8000_Min, extremeWrithes_top8000_Max = git.readResultsCcode_closedLoops(inputFileName = fileName, linksAndPokes_b = 0, minMaxOut_b = 1)
#sort the results and plot distributions (parts of) and link/poke examples (outside cutOff's)
chainsFile = root + r'\chains_subChainPairs_top8000.txt'
#convert structure and then plot
extremeWrithes_top8000 = extremeWrithes_top8000_All, extremeWrithes_top8000_Min, extremeWrithes_top8000_Max
git.histoSubChainPairs_minMax(extremeWrithes_top8000, bins=100, color = 'blue', colorMin = 'orange', colorMax = 'blue', addSubplotToFirstPlot_b = 1, addSubPlotNr = 122, distrPlotsInSubPlots_b =0, showTopNr = 10, plotTop10_b = 1, plotExs_b = 0, chainsFile = chainsFile, interval = [-1.1,-1.0], plotExsInInt_b =0, subChainLgth =  30, lowerPercentile = 0.001, upperPercentile = 0.999)
...
#        linkValues.sort(reverse = True) #21-Aug-2016
    ...
    print "Top %d link values:" % len(linkValues[:5])
    print linkValues[:5]  #Obs: sorted above (btw: moved the sorting on 21-Aug2016)
    print "Top %d lowest link values:" % len(linkValues[::-1][:5])
    ...
    print "Top %d poke values:" % len(pokeValues[:5])
    print pokeValues[:5] #Obs: sorted above (btw: moved the sorting on 21-Aug2016)
    print "Top %d lowest poke values:" % len(pokeValues[::-1][:5])
...
def histoSubChainPairs_minMax(subChainPairValues,
    ...
    #        ax_1 = ax1[1]
            title = 'Unrestricted search' #'Sub-chains of lgth '+ str(subChainLgth) #Unrestricted search
    ...
    if (plotTop4_b == 1 or plotTop10_b ==1): 
        ...
        print "Top %d lowest link values:" % len(subChainPairValuesAll[::-1][:m])
